...
public class SubscribedProdService {
	...
	public List<SubscribedProdDTO> getByBuyerid(@PathVariable String buyerid) throws ShoppingException{
		...
		if(subscribedprodDTO.isEmpty())
			throw new ShoppingException("Service.EMPTY_BUYER_PRODUCTS");
		return subscribedprodDTO;
	}
	
	//Get all subscribed products
	public List<SubscribedProdDTO> getAllSubProduct() throws ShoppingException{
		...
		if(subscribedprodDTOs.isEmpty())
			throw new ShoppingException("Service.NO_SUBSCRIBED_PRODUCTS");
		logger.info("Subscribed Product Details : {}", subscribedprodDTOs);
		return subscribedprodDTOs;
	}
	
	public void createSubscribedProduct(SubscribedProdDTO subscribeProdDTO) throws ShoppingException {
